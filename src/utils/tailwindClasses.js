...
export const HOME = {
    container:[
      //mobile
      'min-h-[100vh] font-Barlow  bg-no-repeat bg-cover bg-center transition-opacity duration-[1000ms] ease-in-out'
    ]
}
...
export const CREW = {
    ...
    crewTabs:[
      //mobile
      'crew-tabs w-[1rem] h-[1rem] rounded-full bg-light-blue mx-[.5rem] cursor-pointer hover:bg-lighting',
      //tablet
      'tablet:mx-[.75rem]',
      //pre lap
...
export const TECHNOLOGY = {
    ...
    technologiesTabs:[
      //mobile
      'technologies-tabs flex justify-center items-center text-sub-h2 font-Bellefair font-bold w-[4rem] h-[4rem] rounded-full border-[.1rem] border-lighting/[.25] mx-[.5rem] cursor-pointer hover:bg-lighting hover:text-darking',
      //tablet
      'tablet:mx-[.75rem]',
      //pre lap
